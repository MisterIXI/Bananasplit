...
- Added Delay option in settings
- Undo button now doubles as undo split and undo selection
- Added color to the maintimer (and an option to disable that)
- Added EditSplits window + add up option + small calculator to subtract one time of another
- Added EditGoldSpltis window
- Added option to replace the SoB with Best Possible time
- Fixed a bunch of bugs (e.g. crash on save)
